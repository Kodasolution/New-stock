...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/forbidden.css') }}">
</head>
...
<body>
    ...
    <h1>403</h1>
    <h2>Not this time, access forbidden!<br>
        <a href="{{ route('admin.dashboard') }}" class="btn btn-info mt-2">Return Home</a>
    </h2>
</body>
