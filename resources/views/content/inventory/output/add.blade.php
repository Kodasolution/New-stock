...
@section('content')
    ...
    <h4 class="py-3 breadcrumb-wrapper mb-4"><span class="text-muted fw-light"></span> Liste des sorties</h4>
        ...
        <div class="col-xxl">
            <div class="card mb-4">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <h5 class="mb-0">Ajouter une sortie</h5>
                    {{--  <small class="text-muted float-end">Default label</small>  --}}
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('inventory.storeOutput') }}">
                        @csrf
                        <div class="row mb-3">
