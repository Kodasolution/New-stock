    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-end">
                <a href="{{ route('inventory.output') }}" class="btn btn-primary mx-2 my-1"><i
                        class="bx bx-plus me-2"></i>Ajouter une sortie</a>
            </div>
            <div class="row">
                <form action="{{ route('inventory.sorties') }}" method="GET" class="d-sm-flex  col-9 ">
                    ...
                    <div class="col-sm-3 m-3">
                        ...
                        <a href="{{ route('inventory.sorties') }}" class= "btn btn-dark  mb-3">Reset</a>
                    </div>
                </form>
