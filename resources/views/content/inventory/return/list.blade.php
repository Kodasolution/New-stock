    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-end">
                <a href="{{ route('inventory.retour') }}" class="btn btn-primary mx-2 my-1"><i
                        class="bx bx-plus me-2"></i>Ajouter un retour</a>
            </div>
            <div class="row">
                <form action="{{ route('inventory.return') }}" method="GET" class="d-sm-flex  col-9 ">
                    ...
                    <div class="col-sm-3 m-3">
                        ...
                        <a href="{{ route('inventory.return') }}" class= "btn btn-dark  mb-3">Reset</a>
                    </div>
                </form>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item"
                                            href="{{ route('inventory.editReturn', [$mouvement->id]) }}"><i
