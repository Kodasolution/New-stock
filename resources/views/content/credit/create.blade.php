...
<div class="row">
  ...
  <div class="col-xxl">
    <div class="card mb-4">
      ...
      <div class="card-body">
        <form method="POST" action="{{ route('client-credit.store') }}" >
          @csrf
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <input type="text" name="montant" class="form-control @error('montant') is-invalid @enderror" id="basic-default-name" placeholder="Enter amount" />
              @error('montant')
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <input type="text" name="description" class="form-control @error('description') is-invalid @enderror" id="basic-default-name" placeholder="Enter the description" />
              @error('description')
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <input type="date" name="date_credit" class="form-control @error('date_credit') is-invalid @enderror" id="basic-default-name" placeholder="Enter the date" />
              @error('date_credit')
                <div class="invalid-feedback">{{ $errors->first('date_credit') }}</div>
              @enderror
            </div>
          </div>
