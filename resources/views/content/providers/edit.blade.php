...
<div class="row">
  ...
  <div class="col-xxl">
    <div class="card mb-4">
      ...
      <div class="card-body">
        <form method="POST" action="{{ route('provider.update', $providers->id) }}" >
            @csrf
            @method('patch')
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              ...
              id="basic-default-name" placeholder="Enter first name" value="{{ $providers->firstName }}" />
              @error('firstName')
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              ...
              id="basic-default-name" placeholder="Enter last name" value="{{ $providers->lastName }}" />
              @error('lastName')
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              ...
              id="basic-default-name" placeholder="Enter phone number" value="{{ $providers->phone }}" />
              @error('phone')
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              ...
              id="basic-default-name" placeholder="Enter email" value="{{ $providers->email }}" />
              @error('email')
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              ...
              id="basic-default-name" placeholder="Enter adress" value="{{ $providers->adress }}" />
              @error('adress')
