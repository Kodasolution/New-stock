        ...
        <div class="col-xxl">
            <div class="card mb-4">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <h5 class="mb-0">Modifier un remboursement</h5>
                    {{--  <small class="text-muted float-end">Default label</small>  --}}
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('expenses.remboursement.update', $remboursements->id) }}">
                        @csrf
                        @method('patch')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                                ...
                                <select id="select2"
                                    ...
                                    <option value="{{ $remboursements->id }}">
                                        @if ($remboursements->dette->type == 'user')
                                            {{ $remboursements->dette->user->firstName }}
                                            {{ $remboursements->dette->user->lastName }}
                                        @else
                                            {{ $remboursements->dette->client->firstName }}
                                            {{ $remboursements->dette->client->lastName }}
                                        @endif
                                    </option>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="montant_rembourse"
                                    ...
                                    value="{{ $remboursements->montant_rembourse }}" />
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                                <input type="date" name="date_rembourse"
                                    ...
                                    value="{{ $remboursements->date_rembourse }}" />
