    ...
    <div class="card">
        <div class="card-header ">
            <div class="d-flex justify-content-end">
                <a href="{{ route('expenses.add') }}" class="btn btn-primary"><i class="bx bx-plus me-0 me-lg-2"></i>
                    Aller au marché</a>
            </div>
            <div class="row">
                <form action="{{ route('expenses.list') }}" method="GET" class="d-sm-flex col-9 ">
                    ...
                    <div class="col-sm-3 m-3">
                        ...
                        <a href="{{ route('expenses.list') }}" class= "btn btn-dark  mb-3">Reset</a>
                    </div>
                </form>
                                ...
                                <td class="action">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{ route('expenses.show', [$depense->id]) }}"><i
