    ...
    <div class="row">
        ...
        <div class="col-xxl">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('expenses.update', $depenses->id) }}">
                        @csrf
                        @method('PATCH')
              ...
              <div class="col-sm-10">
                <select class="form-select @error('type') is-invalid @enderror" data-allow-clear="true" name="type">
                  <option value="{{ old('type', $depenses->type) }}">Choose Type</option>
                  <option value="autres" {{ $depenses->type === 'autres' ? 'selected' : '' }}>Autres</option>
                  <option value="ingredients" {{ $depenses->type === 'ingredients' ? 'selected' : '' }}>Ingrédients</option>
                </select>
                @error('type')
                ...
                @enderror
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="title"
                                    ...
                                    placeholder="Enter title" value="{{ old('title', $depenses->title) }}" />
                                @error('title')
                        ...
                        {{--  <div class="row mb-3 {{ old('type', $depenses->type) === 'autres' ? 'd-none' : '' }}" id="selectIngredientsAutres">
              ...
              <div class="col-sm-10">
                  <select id="select2Multiple" class="select2 form-select" name="ingredients[]" multiple>
                      ...
                      @endforeach
                        ...
                        {{--  <div class="row mb-3 {{ old('type', $depenses->type) === 'ingredients' ? '' : 'd-none' }}" id="selectIngredientsIngredients">
              <label for="select2Multiple" class="col-sm-2 col-form-label">Ingrédients</label>
              <div class="col-sm-10">
                  <select id="select2Multiple" class="select2 form-select" name="ingredients[]" multiple>
                      @foreach ($ingredients as $ingredient)
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="amount"
                                    class="form-control @error('title') is-invalid @enderror" id="basic-default-name"
                                    placeholder="Enter amount" value="{{ old('amount', $depenses->amount) }}" />
                                @error('amount')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="date" name="date_creation"
                                    ...
                                    value="{{ old('date_creation', $depenses->date_creation) }}" />
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select id="select2"
                                    ...
                                    <option value="{{ old('user_id', $depenses->user_id) }}">Choose user</option>
                                    @foreach ($users as $user)
                                        <option value="{{ $user->id }}"
                                            {{ $depenses->user_id === $user->id ? 'selected' : '' }}>
