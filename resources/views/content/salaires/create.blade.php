...
@section('content')
    ...
    @endif
    {{-- <h4 class="py-3 breadcrumb-wrapper mb-4"><span class="text-muted fw-light"></span> des salairiés</h4> --}}
        ...
        <div class="col-xxl">
            <div class="card mb-4">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <h5 class="mb-0">Ajouter un salariés</h5>
                    {{--  <small class="text-muted float-end">Default label</small>  --}}
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('user.salaire.store') }}">
                        @csrf
                        ...
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label" for="basic-default-name">Date entrée</label>
                            <div class="col-sm-10">
                                <input type="date" name="date_in"
                                    class="form-control @error('date_in') is-invalid @enderror" id="basic-default-name"
                                    placeholder="Enter the date" value="{{ old('date_in') }}" />
                                @error('date_in')
